    ...
    return (
        <div className="relative flex">
            ...
            <div className={`${contentContainerBase} ${alignmentClasses}`}>
                <div className="bg-gray-200 rounded-xl shadow-lg p-6 hover:shadow-red-500/20 transition-shadow duration-300">
                    <p className="text-sm font-mono text-gray-700 mb-1">{event.date}</p>
                    <h3 className="avenger text-xl tracking-widest text-black">{event.title}</h3>
                    <p className="text-xs font-mono text-red-800 mb-2">{event.time}</p>
                    <p className="text-sm mt-2 font-mono text-gray-800">{event.description}</p>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="min-h-screen font-sans flex items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="w-full max-w-4xl mx-auto">
                <h1 className="avenger text-3xl md:text-4xl text-center mb-12 text-gray-900 font-extralight tracking-wider">
                    Events Timeline
                </h1>
